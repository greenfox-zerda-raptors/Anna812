...
public class Workshop13 {
    ...
    private static void printDirectoryContents(String pathToList) {
        File randomFile = new File(pathToList);
        File randomDir = new File(randomFile.getParent());
        String[] filesInDir = randomDir.list();
        if (randomFile.exists()) {
            System.out.println("This file exists");
        } else {
            System.out.println("SORRY, No " + pathToList + ", here're the files in that directory");
